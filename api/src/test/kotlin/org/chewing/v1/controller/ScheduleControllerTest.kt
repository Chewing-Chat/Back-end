...
class ScheduleControllerTest : RestDocsTest() {
    ...
    fun getSchedule() {
        ...
        val scheduleParticipants = listOf(
            TestDataFactory.createScheduleParticipant(ScheduleParticipantStatus.ACTIVE, ScheduleParticipantRole.PARTICIPANT),
            TestDataFactory.createScheduleParticipant(ScheduleParticipantStatus.ACTIVE, ScheduleParticipantRole.PARTICIPANT),
        )
            ...
            .apply(
                document(
                    ...
                    responseFields(
                        ...
                        fieldWithPath("data.schedules[].isParticipant").description("참여자 여부(true/false)"),
                    ),
                ),
            )
    }
