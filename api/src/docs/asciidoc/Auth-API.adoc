...
== 1-1 회원가입 인증번호 전송 (이미 가입된 번호)

=== 요청(Request)
include::{snippets}/auth-controller-test/send-phone-verification-already-created/http-request.adoc[]
...
== 2-1 비밀번호 초기화를 위한 인증번호 전송 (가입되지 않은 번호)

=== 요청(Request)
include::{snippets}/auth-controller-test/send-phone-verification-reset-not-created/http-request.adoc[]
...
== 3-1 회원가입을 위한 휴대폰 인증 번호 확인 (이미 가입된 번호)

=== 요청(Request)
include::{snippets}/auth-controller-test/sign-up-already-created/http-request.adoc[]
...
== 3-2 회원가입을 위한 휴대폰 인증 번호 확인 (인증번호 불일치)

=== 요청(Request)
include::{snippets}/auth-controller-test/sign-up-wrong-verification-code/http-request.adoc[]
...
== 3-3 회원가입을 위한 휴대폰 인증 번호 확인 (인증번호 만료)

=== 요청(Request)
include::{snippets}/auth-controller-test/sign-up-expired-verification-code/http-request.adoc[]
...
== 4-1 비밀번호 초기화를 위한 휴대폰 인증 번호 확인 (가입되지 않은 번호)

=== 요청(Request)
include::{snippets}/auth-controller-test/reset-credential-user-not-found/http-request.adoc[]
...
== 4-2 비밀번호 초기화를 위한 휴대폰 인증 번호 확인 (인증번호 불일치)

=== 요청(Request)
include::{snippets}/auth-controller-test/reset-credential-wrong-verification-code/http-request.adoc[]
...
== 4-3 비밀번호 초기화를 위한 휴대폰 인증 번호 확인 (인증번호 만료)

=== 요청(Request)
include::{snippets}/auth-controller-test/reset-credential-expired-verification-code/http-request.adoc[]
...
=== 요청(Request)
include::{snippets}/auth-controller-test/login-wrong-password/http-request.adoc[]
...
=== 요청(Request)
include::{snippets}/auth-controller-test/login-not-found-user/http-request.adoc[]
