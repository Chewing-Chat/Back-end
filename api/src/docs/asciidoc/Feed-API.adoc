...
=== 응답(Response)
include::{snippets}/feed-controller-test/add-feed-failed-file-name-could-not-be-empty/http-response.adoc[]

=== 응답 필드 설명(Response Fields)
include::{snippets}/feed-controller-test/add-feed-failed-file-name-could-not-be-empty/response-fields.adoc[]

== 2-2. 피드 작성 (파일 변환 실패) 02/11 수정

=== 응답(Response)
include::{snippets}/feed-controller-test/add-feed-failed-file-convert-failed/http-response.adoc[]

=== 응답 필드 설명(Response Fields)
include::{snippets}/feed-controller-test/add-feed-failed-file-convert-failed/response-fields.adoc[]

== 2-3. 피드 작성 (파일 저장 실패) 02/11 수정

=== 응답(Response)
include::{snippets}/feed-controller-test/add-feed-failed-file-upload-failed/http-response.adoc[]

=== 응답 필드 설명(Response Fields)
include::{snippets}/feed-controller-test/add-feed-failed-file-upload-failed/response-fields.adoc[]

== 2-4. 피드 작성 (적절하지 않은 이름) 02/11 수정

=== 응답(Response)
include::{snippets}/feed-controller-test/add-feed-failed-file-name-incorrect/http-response.adoc[]

=== 응답 필드 설명(Response Fields)
include::{snippets}/feed-controller-test/add-feed-failed-file-name-incorrect/response-fields.adoc[]
